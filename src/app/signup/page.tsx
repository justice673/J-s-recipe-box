            ...
            <div className="max-w-sm mx-auto w-full">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600" style={{ fontFamily: 'Outfit, sans-serif' }}>
                  Join thousands of food lovers sharing recipes
                </p>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                {/* Full Name Field */}
                <div>
                  <label htmlFor="fullName" className="block text-sm font-semibold text-gray-700 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
                    Full Name
                  </label>
                  <div className="relative">
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-700 mb-2" style={{ fontFamily: 'Outfit, sans-serif' }}>
                    Confirm Password
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="flex items-start">
                  ...
                  />
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-700" style={{ fontFamily: 'Outfit, sans-serif' }}>
                    I agree to the{' '}
